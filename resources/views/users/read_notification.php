    ...
    <div class="pt-36">
        <div class="flex">
            <div class="self-start w-full border shadow-md rounded-md p-4">
                <h1 class="text-xl font-bold mb-1">Notifikasi dari <?= $params['senderStore']['nama_toko'] ?? $params['senderAdmin']['nama'] ?> - <?= $params['senderAdmin']['role'] ?></h1>
                <hr class="mb-3">
                <div class="border rounded-lg p-2">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-xs font-bold">From: <?= $params['senderStore']['nama_toko'] ?? $params['senderAdmin']['nama'] ?> - <?= $params['senderAdmin']['role'] ?></p>
                        </div>
                    </div>
                    <hr class="my-4">
