    ...
    <div class="pt-36">
                ...
                <div class="inner-envelope p-5">
                    <div class="flex justify-between items-center mb-3">
                        ...
                        <div class="text-sm font-semibold">
                            <p>Pengiriman: Express</p>
                            <p>9123888237482</p>
                        </div>
                    </div>
                    <div class="flex items-start gap-10 text-sm font-medium">
                        <div>
                            <p class="mb-1">Nama penerima: Atyla Azfa Al Harits</p>
                            <p>+62 812 9889 7305</p>
                            <p>Jl. Cempaka Biru, 014/04, Tambakreja, Lakbok, Ciamis, Jawa barat, 46385</p>
                        </div>
                        <div>
                            <p class="mb-1">Catatan untuk kurir:</p>
                            <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Iste rem minima earum a non, doloremque doloribus qui maxime voluptates quis.</p>
                        </div>
                    </div>
        ...
        <div class="border p-4 mb-5">
            ...
            <div class="flex justify-center items-center">
                ...
                <div class="border-4 border-red-primary w-56"></div>
                <div class="flex flex-col items-center">
                    <div class="border-4 border-red-primary text-red-primary rounded-full h-16 w-16 flex justify-center items-center mb-3">
        ...
        <div class="border p-4 mb-5">
            ...
            <div class="flex gap-5 mb-4">
                ...
                <div>
                    <h1 class="text-lg font-semibold">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Modi, explicabo?</h1>
                    <p class="text-xs font-medium">x10</p>
                    <p class="text-xs font-medium">Rp.20.000</p>
                </div>
            </div>
