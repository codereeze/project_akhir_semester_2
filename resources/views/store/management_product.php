            ...
            <div>
                <div class="flex justify-between items-center mb-5">
                    <div class="flex gap-3">
                        ...
                        <div class="max-w-lg">
                            <h2 class="text-lg font-bold leading-6 mb-2">Lorem ipsum dolor sit amet consectetur adipisicing elit. Cumque, dignissimos!</h2>
                            <div class="text-xs font-medium">
                                <p>Ukuran tersedia: S, M, L, XL, XXL</p>
                                <p>Stock: 300</p>
                                <p>Harga: Rp20.000</p>
                            </div>
                        </div>
                    ...
                    <div>
                        <a href="">
                            <button class="bg-red-primary p-2 rounded-md font-semibold text-sm text-white hover:bg-red-500 duration-300 mr-1"><i class="fas fa-trash"></i> Hapus</button>
                        </a>
                        <a href="">
