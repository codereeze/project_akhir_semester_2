                ...
                <div class="mb-5 shadow-md p-4 rounded-md">
                    <div class="grid grid-cols-2 gap-3">
                        <div>
                            ...
                            <input type="text" class="p-2 rounded-md border w-full font-medium" value="" name="nama_produk">
                        </div>
                        <div>
                            <p class="font-semibold mb-1">Harga per-pcs</p>
                            <input type="number" class="p-2 rounded-md border w-full font-medium" value="" name="harga">
                        </div>
                        <div>
                            <p class="font-semibold mb-1">Nama Brand/Merk</p>
                            <input type="text" class="p-2 rounded-md border w-full font-medium" value="" name="merk">
                        </div>
                        <div>
                            <p class="font-semibold mb-1">Kategori</p>
                            <select class="p-2 rounded-md border w-full font-medium" value="" name="kategori_id">
                        ...
                        <div>
                            ...
                            <input type="number" class="p-2 rounded-md border w-full font-medium" value="" name="stock">
                        </div>
                        <div>
                            <p class="font-semibold mb-1">Size Tersedia</p>
                            <div class="flex items-center gap-5">
                                <div class="flex items-center mb-4 h-10">
                                    <input id="default-checkbox1" type="checkbox" value="Yes" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded cursor-pointer" name="size_s">
                                    <label for="default-checkbox1" class="ms-2 text-sm font-medium text-gray-900">S</label>
                                </div>
                                <div class="flex items-center mb-4 h-10">
                                    <input id="default-checkbox2" type="checkbox" value="Yes" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded cursor-pointer" name="size_m">
                                    <label for="default-checkbox2" class="ms-2 text-sm font-medium text-gray-900">M</label>
                                </div>
                                <div class="flex items-center mb-4 h-10">
                                    <input id="default-checkbox3" type="checkbox" value="Yes" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded cursor-pointer" name="size_l">
                                    <label for="default-checkbox3" class="ms-2 text-sm font-medium text-gray-900">L</label>
                                </div>
                                <div class="flex items-center mb-4 h-10">
                                    <input id="default-checkbox4" type="checkbox" value="Yes" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded cursor-pointer" name="size_xl">
                                    <label for="default-checkbox4" class="ms-2 text-sm font-medium text-gray-900">XL</label>
                                </div>
                                <div class="flex items-center mb-4 h-10">
                                    <input id="default-checkbox5" type="checkbox" value="Yes" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded cursor-pointer" name="size_xxl">
                    ...
                    <div class="mb-5">
                        ...
                        <textarea rows="5" name="deskripsi" id="" class="p-2 rounded-md border w-full font-medium block"></textarea>
                    </div>
