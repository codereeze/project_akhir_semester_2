                    ...
                    <form action="" method="post">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="" id="" class="form-control mb-4" value="Karina Elfira">
                            </div>
                            <div class="col-md-6">
                                <label for="" class="fw-bold mb-2">Email</label>
                                <input type="text" name="" id="" class="form-control mb-4" value="karina@gmail.com">
                            </div>
                            <div class="col-md-6">
                                <label for="" class="fw-bold mb-2">Telepon</label>
                                <input type="text" name="" id="" class="form-control mb-4" value="0812988973555">
                            </div>
                            <div class="col-md-6">
                                <label for="" class="fw-bold mb-2">Gender</label>
                                <input type="text" name="" id="" class="form-control mb-4" value="Perempuan">
                            </div>
                            </div>
